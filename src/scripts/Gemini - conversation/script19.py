...
def extract_messages(main_folder):
  ...
  with open("../../../collectedData/Gemini - conversation/message_content19.json", "w", encoding='utf-8') as f:
...
def extract_hrefs(main_folder):
  ...
  with open("../../../collectedData/Gemini - conversation/liked_content19.json", "w", encoding='utf-8') as f:
