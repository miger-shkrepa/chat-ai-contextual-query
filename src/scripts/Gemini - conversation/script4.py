  ...
  for root, dirs, files in os.walk(main_folder):
    for file in files:
      if file == "message_1.json":
        ...
        try:
          with open(file_path, 'r', encoding='utf-8') as f:  # Specify encoding when reading
            data = json.load(f)
            if "messages" in data:
...
if __name__ == "__main__":
  ...
  with open("../../../collectedData/Gemini - conversation/extracted_messages4.txt", "w", encoding='utf-8') as f:  # Specify encoding when writing
