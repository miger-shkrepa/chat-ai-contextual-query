        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            if message_class:
                for outer_div in soup.find_all('div', class_=message_class):
                    ...
                    if len(nested_divs) >= 2:  # Ensure we have the second nested div
...
output_message_json = os.path.join(output_folder, "message_content9.json")
output_liked_json = os.path.join(output_folder, "liked_content9.json")
